...
@log_function_call
def get_openai_completion(prompt, model="o3-mini", timeout=60):
    """Use OpenAI for responses with timeout."""
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            try:
                ...
                log_error(f"Timeout ({timeout}s) exceeded for OpenAI API call")
...
@log_function_call
def get_together_completion(prompt, include_thinking=False, timeout=120):
    """Use Together AI DeepSeek-R1 for responses with timeout."""
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            try:
                ...
                log_error(f"Timeout ({timeout}s) exceeded for Together API call")
                return "Response timed out. Please try again."
...
@log_function_call
def get_claude_completion(prompt, include_thinking=False, timeout=60):
    """Use Claude for responses with timeout."""
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            try:
                ...
                log_error(f"Timeout ({timeout}s) exceeded for Claude API call")
                return "Response timed out. Please try again."
...
@log_function_call
def get_groq_completion(prompt, include_thinking=False, timeout=60):
    """Use Groq DeepSeek-R1-Distill-Qwen-32B for responses with timeout."""
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            try:
                ...
                log_error(f"Timeout ({timeout}s) exceeded for Groq API call")
                return "Response timed out. Please try again."
